...
async function createFiles(outputDirectory) {
    try {
        ...
        const data = await fs.readFile(`${cleanedTempPackagePath}/templates/reactTemplate.json`, 'utf8');
        ...
        const files = [
            ...
            { fileName: '/src/app/layout.jsx', content: templateData['RootLayout.jsx'] },
            { fileName: '/src/app/page.jsx', content: templateData['Home.jsx'] }
        ];

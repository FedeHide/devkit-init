...
progress_bar
pnpx --yes tailwindcss init -p # >/dev/null 2>&1

cd ..
## CLEANING
progress_bar
rm "$outputDirectory"/src/main.jsx "$outputDirectory"/src/App.jsx "$outputDirectory"/src/App.css "$outputDirectory"/src/index.css # >/dev/null 2>&1

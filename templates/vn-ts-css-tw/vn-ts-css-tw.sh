...
progress_bar
pnpm install -D typescript@latest eslint@8.56 @typescript-eslint/eslint-plugin@7.8.0 eslint-config-love@latest eslint-plugin-import@latest eslint-plugin-n@16.0.0 eslint-plugin-promise@latest >/dev/null 2>&1
progress_bar

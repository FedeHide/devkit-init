...
progress_bar
pnpm install -D eslint@^8.57.0 eslint-config-standard@latest eslint-plugin-import@latest eslint-plugin-n@16.0.0 eslint-plugin-promise@^6.0.0 >/dev/null 2>&1
progress_bar
